...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/a57bf5ee3bbaabe0b865f70ce04c5278', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/a57bf5ee3bbaabe0b865f70ce04c5278',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        "value": function () {return 'DEMO ' + (this.title)},
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "resize": "cover",
	                "src": function () {return this.item.picsrc}
	              },
	              "events": {
	                "click": "clickImg"
	              }
	            ...
	            {
	              "type": "nav-bar",
	              "id": function () {return 'top' + (this.$index)},
	              "classList": [
	                "navbar"
	              ],
	              "attr": {
	                "title": function () {return this.time}
	              },
	              "events": {
	                "click": "clickNav"
	              }
	            ...
	            {
	              "type": "div",
	              "id": function () {return 'img-info' + (this.$index)},
	              "classList": [
	                "bottom"
	              ],
	              "events": {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return (this.item.content) + ' by ' + (this.item.author)}
	                  }
	                }
	              ]
	            }
...
/***/ function(module, exports) {
	...
	module.exports = {
		data: function () {return {
			time: '2016-12-20',
			list: [{ 'id': 0, 'index': 0, 'time': '2016', 'content': '太阳当空照，花儿对我笑，小鸟说：早早早，你为什么背着小书包。。。', 'author': 'DINGDANG', 'picsrc': 'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=715133909,3016426832&fm=21&gp=0.jpg' }, { 'id': 1, 'index': 1, 'time': '2016', 'content': '人之初 性本善 性相近 习相远 苟不教 性乃迁 教之道 贵以专', 'author': 'DINGDANG', 'picsrc': 'http://img06.tooopen.com/images/20161113/tooopen_sl_186542832657.jpg' }, { 'id': 2, 'index': 2, 'time': '2016', 'content': '树欲静而风不止 子欲养而亲不在 ', 'author': 'DINGDANG', 'picsrc': 'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=2725035265,1735414183&fm=21&gp=0.jpg' }, { 'id': 3, 'index': 3, 'time': '2016', 'content': '树欲静而风不止 子欲养而亲不在 ', 'author': 'DINGDANG', 'picsrc': 'https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=234547529,4156186303&fm=21&gp=0.jpg' }, { 'id': 4, 'index': 4, 'time': '2016', 'content': '树欲静而风不止 子欲养而亲不在 ', 'author': 'DINGDANG', 'picsrc': 'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=2137201449,2953361531&fm=21&gp=0.jpg' }],
			shownav: 'false',
			index: 0,
			deviceHeight: 1024,
			translate_top: '',
