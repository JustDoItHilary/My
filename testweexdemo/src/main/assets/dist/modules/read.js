...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/9631c6f0e6596c3b8016fa76e6fe825a', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/9631c6f0e6596c3b8016fa76e6fe825a',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(5);
	var modal = __weex_require__('@weex-module/modal');
	var apis = __webpack_require__(94);
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        openSerialDetail: function openSerialDetail(id) {
	            modal.toast({ 'message': "openSerial" + id, 'doation': 1 });
	            __weex_require__('@weex-module/myModule').printLog(this.$getConfig().bundleUrl);
	            var vm = this;
	            var params = {
	                'url': this.baseURL + 'modules/serial-detail.js?id=' + id,
	                'animated': 'true'
	            };
	            __weex_require__('@weex-module/myModule').printLog(params.url);
	            navigator.push(params, function (e) {});
	        },
	        openQuestionDetail: function openQuestionDetail(id) {
	            modal.toast({ 'message': "openQuestion" + id, 'doation': 1 });
	            var vm = this;
	            var params = {
