...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/03502c0bef82fd1972defecdd5fa32ba', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/03502c0bef82fd1972defecdd5fa32ba',undefined,undefined)
	    ...
	    },
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "append": "tree",
	          "repeat": {
	            "expression": function () {return this.userinfolist},
	            "value": "item"
	          },
	          "attr": {
	          ...
	          "children": [
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.item.src_url}
	                  }
	                },
	                {
	                  "type": "text",
	            ...
	            },
	            {
	              ...
	              "shown": function () {return this.item.showType4},
	              "children": [
	                {
	                  "type": "div",
	                  "classList": [
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        userlist: [{ type: 1, title: "用户头像", src_url: "http://gtms01.alicdn.com/tps/i1/TB1qw.hMpXXXXagXXXX9t7RGVXX-46-46.png", defaultValue: "", warn: "", value: "" }, { type: 2, title: "姓名", src_url: "http://gtms01.alicdn.com/tps/i1/TB1qw.hMpXXXXagXXXX9t7RGVXX-46-46.png", defaultValue: "输入姓名", warn: "最多输入10个字", value: "" }, { type: 3, title: "职业", src_url: "http://gtms01.alicdn.com/tps/i1/TB1qw.hMpXXXXagXXXX9t7RGVXX-46-46.png", defaultValue: "无", warn: "" }, { type: 4, title: "出生日期", src_url: "http://gtms01.alicdn.com/tps/i1/TB1qw.hMpXXXXagXXXX9t7RGVXX-46-46.png", defaultValue: "", warn: "", value: "2016-12-08" }],
	        readingList: [],
	        userinfolist: [],
	        currentIndex: 0,
	        baseURL: '',
	    ...
	    methods: {
	        ...
	        getUserInfoList: function getUserInfoList(index, loadmore) {
	            var self = this;
	        ...
	        getType: function getType(items, callback) {
...
/***/ function(module, exports) {
	...
	exports.getReadingIndex = function (index, callback) {
	    requestGet(apiUrl.baseurl + apiUrl.readingIndex + index, callback);
	};

	exports.getUserList=function(index,callback){
		requestGet(apiUrl.userlistUrl,callback);
	};
