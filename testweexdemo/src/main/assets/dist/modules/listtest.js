...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/ac6dd85937a5bf175f5d9261cdcebbc1', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/ac6dd85937a5bf175f5d9261cdcebbc1',undefined,undefined)
	            ...
	            },
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.item.content.author.user_name}
	                  }
	                },
	                {
	                  "type": "div",
	    ...
	    methods: {
	        ...
	        getReadingIndex: function getReadingIndex(index, loadmore) {
	            ...
	            apis.getReadingIndex(index, function (ret) {
	                modal.toast({ 'message': { ret: ret }, 'duation': 1 });
	                __weex_require__('@weex-module/myModule').printLog({ ret: ret });
	                if (!loadmore) {
	                    self.readingList = [];
	                }
	        ...
	        click: function click(mess) {
	            var self = this;
	            __weex_require__('@weex-module/myModule').printLog(" 人生掌握在自己手中 ");
	        },
	        onEditInfo: function onEditInfo(e) {
	            var self = this;
	            var value = e.target.children[1].attr.value;
	            __weex_require__('@weex-module/textBoxModule').editTextBoxInfo({ "name": "宁澜 ", "value": value, "def": "输入姓名", "warn": "最多输入10个字" }, function (e) {

	                var mess = e;

	                __weex_require__('@weex-module/myModule').printLog(mess);
	            });
	        },
	        ...
	        openEssayDetail: function openEssayDetail(id) {
	            ...
	            navigator.push(params, function (e) {
	                __weex_require__('@weex-module/myModule').printLog({ e: e });
	            });
	            __weex_require__('@weex-module/myModule').printLog(this.baseURL + 'modules/essay-detail.js?id=' + id);
	        }
	    },
	    created: function created() {
	        var self = this;
