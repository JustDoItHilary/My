...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/5898a5de89a1e069394ba4fd9597bc38', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/5898a5de89a1e069394ba4fd9597bc38',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        ...
	        "titleColor": "#000000",
	        "leftItemSrc": "https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=2192841312,1420710418&fm=116&gp=0.jpg",
	        "rightItemTitle": "刷新",
	        "rightItemColor": "#33aaff"
	      }
	    },
	    {
	      "type": "list",
	      ...
	      "style": {
	        "marginTop": function () {return this.navpageHeight}
	      },
	      "children": [
	        {
	          "type": "header",
	        ...
	        },
	        {
	          ...
	          "attr": {
	            "display": function () {return this.isShowRefresh}
	          },
	          "children": [
	            {
	              "type": "text",
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "url": function () {return this.item.content.web_url}
	              },
	              "style": {
	                "borderBottomWidth": 1,
	                "borderColor": "#cccccc"
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.item.content.title}
	                  }
	                },
	                {
	                  "type": "text",
	                  ...
	                  "attr": {
	                    "value": function () {return '作者/ ' + (this.item.content.author)}
	                  }
	                },
	                {
	                  "type": "text",
	                  ...
	                  "attr": {
	                    "value": function () {return this.item.content.excerpt}
	                  }
	                },
	                {
	                  "type": "div",
	        ...
	        },
	        {
	          ...
	          "attr": {
	            "display": function () {return this.isSHowLoading}
	          },
	          "children": [
	            {
	              "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  data: function () {return {
	    ...
	    url: 'http://v3.wufazhuce.com:8000/api/reading/index/0',
	    list: [{ "time": "2016-12-20",
	      "type": 2,
	      "content": {
	        "id": "217",
	        "serial_id": "35",
	        "number": "10",
	        "title": "灰猫奇异事务所·坚果大劫案（二）",
	        "excerpt": "真是意外，和灰猫住了这么久，现在才知道这家伙还有大名。",
	        "read_num": "16900",
	        "maketime": "2016-12-20 21:00:00",
	        "start_video": "",
	        "author": "康夫",
	        "web_url": "http://v3.wufazhuce.com:8000/api/serialcontent/217"
	      } }, { "time": "2016-12-20",
	      "type": 2,
	      "content": {
	        "id": "217",
	    ...
	    itemUrl: 'http://v3.wufazhuce.com:8000/api//serialcontent/217',
	    isShowRefresh: 'hide',
	    isSHowLoading: 'hide',
	    notice_item_url: ''
	  }},
	  ...
	  methods: {
	    getData: function getData(url, callback) {
	      stream.sendHttp({ method: 'GET', url: url }, function (ret) {
	        var retData = JSON.parse(ret);
	        callback(retData);
	      });
	    },
	    getList: function getList(retdata) {
	      var self = this;
	    ...
	    itemClick: function itemClick(e) {
	      var self = this;
	      var url = self.processUrl(e.target.attr.url);
	    ...
	    refresh: function refresh() {
	      ...
	      self.getData(self.itemUrl, function () {});
	    ...
	    processUrl: function processUrl(url) {
	      ...
	      if (url) {
	        if (platform === 'ios') {
	          return self.notice_item_url + '?weburl=' + url;
	        } else if (platform === 'web') {
	          return url;
	        } else {
	          var encodeUrl = encodeURIComponent(url);
	          return self.notice_item_url + '?weburl=' + encodeUrl;
	        }
	      }
	    }
	  }
