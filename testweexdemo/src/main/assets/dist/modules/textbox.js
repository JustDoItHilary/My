...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/547b7851609bfaea379e0460cc1b9937', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/547b7851609bfaea379e0460cc1b9937',undefined,undefined)
	...
	module.exports = {
		...
		methods: {
			...
			click: function click() {
				this.imgSrc = "https://img.alicdn.com/tps/TB1ZVOEOpXXXXcQaXXXXXXXXXXX-200-200.png";
			}
		}
	};}
	...
	module.exports = {
	  ...
	  "children": [
	      ...
	      "children": [
	        {
	          "type": "switch",
	          "attr": {
	            "checked": function () {return this.isChecked}
	          },
	          "events": {
	            "click": "clickSwitch",
	            "change": "changeSwitch",
	            "disappear": "disappearSwitch",
	            "appear": "appearSwitch"
	          }
	        },
	        {
	    ...
	    },
	    {
	      ...
	      "attr": {
	        "title": "叮咚叮咚",
	        "imgsrc": "https://img.alicdn.com/tps/TB1ZVOEOpXXXXcQaXXXXXXXXXXX-200-200.png"
	      },
	      "events": {
	        "click": "toTop"
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		data: function () {return {
			list: ["a", "b", "c", "a", "b", "c", "a", "b", "c", "a", "b", "c", "a", "a"],
			result: 0,
		...
		methods: {
			add: function add(x) {
				...
				this.list.$set(1, this.result);
				this.$vm('foo').setTitle("喵呜" + this.result);
			},
			...
			nav: function nav() {
				var params = { 'url': this.url, 'animated': 'true' };
				navigator.push(params, function (e) {
					modal.toast({ 'message': 'ok', 'doation': 1 });
					console.log('i am the callback ' + e);
				});
			},
			change: function change() {
				this.isChecked = !this.isChecked;
				this.isShowSwitch = 'hide';
			},
			clickSwitch: function clickSwitch(event) {},
			changeSwitch: function changeSwitch(e) {
				modal.toast({ 'message': e.value, 'doation': 1 });
			},
