...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/81beb290995d8810b1bd185dfcceaac1', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/81beb290995d8810b1bd185dfcceaac1',undefined,undefined)
	...
	module.exports = {
	  ...
	  methods: {
	    push: function push() {
	      ...
	      __weex_require__('@weex-module/myModule').printLog(this.baseURL + 'component/navigator-demo.js?test=1');
	      var params = {
	        'url': this.baseURL + 'component/navigator-demo.js?test=1',
	        'animated': 'true'
	      };
	      modal.alert({ 'message': this.baseURL, 'oktitle': 'ok' });
