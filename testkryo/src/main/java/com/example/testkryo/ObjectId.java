...
public class ObjectId implements Comparable<ObjectId>, java.io.Serializable {
    ...
    /**
     * Turn an object into an {@code ObjectId}, if possible. Strings will be
     * converted into {@code ObjectId}s, if possible, and {@code ObjectId}s will
     * be cast and returned. Passing in {@code null} returns {@code null}.
     *
     * @param o
